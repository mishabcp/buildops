...
router.get('/:projectId/media', listMedia);
router.post('/:projectId/media', mediaUpload.single('file'), createMedia);
router.get('/:projectId/media/:mediaId/file', streamMediaFile);
router.get('/:projectId/media/:mediaId', getMedia);
router.delete('/:projectId/media/:mediaId', removeMedia);
